...
class PlanningErrorCode(str, Enum):
    ...
    LINE_RANGE_GUARD_MISMATCH = "LINE_RANGE_GUARD_MISMATCH"
    PYTHON_SOURCE_INVALID = "PYTHON_SOURCE_INVALID"
    PYTHON_SYMBOL_RESOLUTION_FAILED = "PYTHON_SYMBOL_RESOLUTION_FAILED"
    PYTHON_SYMBOL_GUARD_MISMATCH = "PYTHON_SYMBOL_GUARD_MISMATCH"
    ...
    FORMATTER_BASELINE_INCOMPATIBLE = "FORMATTER_BASELINE_INCOMPATIBLE"
    FORMATTER_PATCH_INCOMPATIBLE = "FORMATTER_PATCH_INCOMPATIBLE"
    ...
    ARCHITECTURE_INSPECTION_FAILED = "ARCHITECTURE_INSPECTION_FAILED"
    ARCHITECTURE_POLICY_FAILED = "ARCHITECTURE_POLICY_FAILED"
...
class ExecutionErrorCode(str, Enum):
    ...
    RUNTIME_CACHE_CLEANUP_FAILED = "RUNTIME_CACHE_CLEANUP_FAILED"
    HTML_LINT_FAILED = "HTML_LINT_FAILED"
